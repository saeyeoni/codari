...
<form name="main_form" method="post" autocomplete="off" enctype="multipart/form-data" >
  ...
  <div class="row">
    ...
    <div class="col-md-6 form-inline">
      ...
      <div class="col-md-12  reset-pd input-group input-group-sm">
        <div class="input-group-prepend" style="visibility: hidden;"><span class="input-group-text">none</span></div>
      </div>
      <div class="col-2 offset-10 reset-pd ">
...
function store(){
  ...
  let work  = theForm.work.value;
  let conn  = theForm.conn.value;
  vSet.push(["input","emp_nb","사번(ID)","empty"]);
  vSet.push(["input","emp_nb","사번(ID)","maxLength",5]);
  vSet.push(["input","emp_nm","이름","empty"]);
  vSet.push(["input","part","부서","empty"]);
  vSet.push(["input","position","직급","empty"]);
  vSet.push(["input","work","재직구분 선택","empty"]);
  vSet.push(["input","conn","해외 접속 여부 선택","empty"]);
